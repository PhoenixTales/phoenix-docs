...
As Mike said in 1998: "Fortunately, no one came too close to our vision of a 3D-RPG by now..." Fortunately or unfortunately, this statement holds still true today. Even Gothic itself came not too close to the vision. So for us
`PHOENIX` is the new `GOTHIC`.
