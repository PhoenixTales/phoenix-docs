...
| 2017 | Flosha re-models the entire Old Camp of the Sequel based on Screenshots. May: logx officially joins the team. The first guild plots are started to be developed. November: Official founding of [PhoenixTales](https://phoenixtales.de). |
...
8. When exactly did Arbax and Adam join?
