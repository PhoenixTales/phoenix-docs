...
The final armour design came from Mike himself, in cooperation with Mike Hoge, evolving the latest concepts that Ralf came up with. Below we will show the mercenary armours as they have been conceptualised by Mike and compare them to the actual ingame realisation of these armours in the game; sadly we only have the concepts of the light and medium armour, none of the heavy one. The ingame models resemble the concepts very well, but there are some little details in which they clearly divert from the concepts. We will argue that in every case these diversions seem to be based on either misinterpretations of the concepts or simply be caused by suboptimal or lazy execution, since they add nothing to the armours and rather make them less believable than they could have been if following the concepts more loyally (this is more so the case with the Organiser armours). We will thus take the armours of the Alpha as we have reconstructed them based on the renderings and Alpha screenshots and improve them based on the details of the concepts from which they divert. We may also consider the latest concepts by Ralf and create variations based on them; especially so for variations of the heavy armours. 
