...
The World v0-1 development is related with the historical phase between the Alpha World v0.9 and the Gothic World v1 (precisely v1.6), whereas v1.6 equals Phoenix World "v0", while Phoenix World v1 is our attempt and result of restoring the Alpha World of v0.9, *preserving* the *relevant* additions from up to v1.6. 
...
* The relevance of each of these changes for the story is taken into account. 
...
Below we will analyse all the Changes by PB. 

### Exchange Place
The World Model has been slightly expanded and additional vobs have been placed, to improve the locations presentation, without altering the existing idea, nor the overall geometry, nor the atmosphere.

Verdict: These changes can be preserved and brought into harmony with the v0.9 version of the Exchange Place. 
...
In the release version, the Old Temple (now conceived as an Old Monastery) and its surrounding terrain has been altered significantly, both the geometry of the terrain as well as the architecture of the ruins.  
In difference to the coherent Alpha design, these architectural alterations turned the ruins into an incoherent and randomly placed collection of stylistically differing ruin sections around a vast court, that conveyed the idea of a monastery less than even the Old Temple that wasn't conceived as one. The Monastery Ruins only presented the outside walls and said court, instead of any ruins by which one could differentiate between the building and the court inside of it. While the idea of an interior court may be sound for a Monastery, the execution of the idea was far from ideal. 
...
The new design also served the purpose to make the ruins inaccessible to the player until intended to be explored in the story (the Monster placement may not have been deemed sufficient).
...
## Western Plains
The western plains are the territory in the West of the OC, between the Old Camp and the New Camp. 

Verdict: ...
(this automatically solves the question of the H-Wood). 
