...
* The Old Mine has changed its place for some reason and was moved from the south to the northwest, as known from the release version. 
* A "new" old pass out of the colony was added close to the Old Mine.
...
* The original "Orc Area" was added between the demontower and the Stone Circle, with an entrance to the OrcCaves/OrcCity dungeon. 
