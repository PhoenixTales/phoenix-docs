...
In 1995-1996 Mike had conceptualised the world and developed it into what we can see in his Orpheus "Overview Map", which we refer to as v3. We have to point out that Mike himself called it v1 since this was the first map he was actually confident about. The ones before were just rough drafts and concepts in development that were never considered to be "good" or complete as they were. Below we will describe how the map was developed from these earliest drafts to the "final" Orpheus map. 


#### The Barrier and its Centre

The Old Camp was always positioned right in the centre of the game world (point 0, at the crossing point of the global X and Y axes). This has never been changed. Only due to the reduction in size of the south and the north of the world in later alpha versions, the barrier's scale had to be reduced and it was squished into an oval shape (originally it was supposed to be a perfect sphere). While the Old Camp has never been moved, this change of the barrier's extent put it slightly off the centre, if the barrier is seen as the border of the gameworld that it is. It was the Old Camp, originally called the "Midcity", that was drawn first and that was always meant to be in the middle of the world. 
...
The Troll Canyon found its way into the game very early on, as seen in v0.56c.
