...
The first and second chapters doesn't contain any Prio1 missions. The first one serves the orientation of the player in the world and the goal is to join a guild. That initiates chapter 2, in which the preparation of the Psi ritual begins (PrepareRitual). 
