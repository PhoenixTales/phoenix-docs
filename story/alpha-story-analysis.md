...
* Many places at the surface didn't play any role in the story yet and were mere ambient locations: The Old Temple Ruins (later Monastery), the Fogtower and Lighttower. The Stonehenge played an important, but different role and the Mountain Fortress didn't yet exist. The Old Fort did play a role already, but also a different one. 
...
* The idea of the liberation party of the Old Camp in Chapter 1 was an event in Story 3.3 already; here the idea has been added that an assassin tries to kill Gomez during the event, but fails.
