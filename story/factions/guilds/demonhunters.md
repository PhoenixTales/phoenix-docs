...
Other than that there is a clear differentiation between light and medium armour, but the heavy armour is identical with the medium one except for the addition of a helmet, which I do not see as an adequate "heavier" version. 
...
(4) the unusual shape of the helmet with the face completely covered in difference to all the other helmets so far and...  
...
While the blue colour could come from magical ore, their irregular and asymmetric shape suggest them to be scales of a creature (and due to the spread of the more powerful red ore, the blue ore has become rare; they rather would have chosen red in that case). Other than that it is just the most obvious explanation that hunters of demons use demon scales for their armours, just as the former regular hunters of the NCs organisation used fur and leather from their prey. 

Due to many creatures in the game not having any scales, it could also be that they are not actual scales, but scale-shaped thick and hardened pieces of leather. But the more likely and obvious explanation would be that they are scales of e.g. demonic crawlers, one of the creatures which were not yet designed in their demonic form, even more so since the NC already used crawler scales in the past (crawler plate armour).
...
* The "helmet" is mostly made from leather too and is thus not described as a helmet but as a mask. The first version has a simple form like a balaclava as some criminals or special units would wear it to cover their face - a new texture is needed for the mask. 
