...
**Summary**: The exclusivity conditions described in V1 are confusing, I don't know what is meant with "X", but it is noteworthy that here Mike wanted to exclude every guild the novices had a bad relationship with from level 0, in accordance with the joining conditions of V1, according to which one has to prove his loyalty. While in V2 almost everyone can join at up to level 3 and they just do not like the mages (nor do the mages like them due to their hereticism) and the paladins (the mercs of the water mages), but they are still allowed atleast at level 1. This does not necessarily mean much though, since the only one they are described to have a bad relationship with in V1 is the evil witcher (Xardas).

When combining this with the later idea though, where they have a rather negative relationship with the healing mages, battlemages and paladins, it tells us more than it may seem at first glance: It shows a shift in the guild conception. As we know, originally, the sect was imagined as a smaller (see our analysis of the [colony population](/story/factions/colony-population)) and very exlusive circle who would be eclectic with accepting new members, similar to the mages. But this idea was discarded very fast, when they had the idea that the sect actively seeks members as their primary ressource and is not eclectic at all. In this way they have shifted from an esoteric circle (in the literal meaning of the word) to an exoteric group as known from so many modern sects, accepting almost anyone since they want to grow as much as possible. The *Gurus* in particular are still representing an esoteric circle within their seemingly open community, but it may be that initially the whole sect was meant to be like this. 
