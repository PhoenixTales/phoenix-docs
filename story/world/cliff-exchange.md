...
When Ralf started to draw concepts of the surface for review by Mike, he diverted quite a bit from Mikes original ideas. But for the most part this may have been caused by a misunderstanding, which we will explain further below. On one hand, he has drawn this concept of the "starting location":
...
[screen from gameplay video]

Alternatively, the Old Temple and its entire area would have to be relocated to a different position in the Colony. 

---

The temple did not have any sources in the design documents we retrieved, the location was not mentioned and its role in the story was not really bound to a specific place. Therefore I considered a relocation as a possible solution, but a solution that I would highly prefer to avoid, as it was presented here as early as in v0.7.  
...
At times during the design process and the many experiments with this area I thought I wouldn't be able to avoid it. 
...
In my prior modeling attempts I did not have considered the rise of the terrain yet, because I saw the way up towards the cliff as a sufficient realisation of this idea. But by radically changing the terrain to solve the problem of the cliff, the exchange place, the northern lake and the northern forest together (by lowering the exchange place in order to rise the forest towards it, removing the mountains inbetween, for a more even inclination, which would only improve the believability regarding the convoys as well as the atmosphere and really get close to the old concepts *without* all that was essential about the terrain as realised in the game from v0.7 onwards); by doing so I realised that the lake behind the forest could be placed so much higher, that it would be over the level of the temple ruins. 

This way, at least parts of the rock faces west of the temple ruins could remain and the water would run down north and probably south of it too into the ocean; from above, on the lake, the temple would not be seen, just some rocks sticking out from the wall, that the water would flow around; from above the player wouldn't know about the temple. And from the bottom, the beach and the monastery itself, you couldn't look upon the lake, but the mountainous region would be preserved, maybe not as high as before, but that really didn't matter, as unfinished as this area was even in the release version of the game. 
